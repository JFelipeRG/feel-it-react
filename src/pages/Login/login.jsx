      ...
      >
        <Form className='form'>
          ...
          <div className='input-container'>
            <Field className='input-form' type='text' name='nick' onBlur={({ target }) => handleBlur(target, 'nick')} />
            <label className='label-form' htmlFor='nick'>Nick</label>
            <ErrorMessage className='error' name='nick' component='span' />
          </div>
          <div className='input-container'>
            <Field className='input-form' type='password' name='passw' onBlur={({ target }) => handleBlur(target)} />
